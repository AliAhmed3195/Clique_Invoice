(function() {
	...
	function StatementPreviewController(InvoiceModel,$timeout, $mdDialog, $filter, triSkins, $window, $rootScope, $scope, SettingModel, Clique,printer,customerData,$http,$cookies) {
