(function () {
    ...
    ItemsModel.$inject = ['$http', 'Clique', '$httpParamSerializer'];

    function ItemsModel($http, Clique, $httpParamSerializer) {
        ...
        service.GetSingleItem = GetSingleItem;
        ...
        function GetSingleItem(id) {
            return Clique.callService('get','/erp/quickbooks/item/'+ id ).then(handleSuccess, handleError);
        }
